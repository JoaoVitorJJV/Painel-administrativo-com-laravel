                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <?php $__currentLoopData = $front_menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuslug => $menutitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li> 
                                            <a href="<?php echo e($menuslug); ?>"><?php echo e($menutitle); ?></a>
                                        </li>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-lg-4">
                        <div class="footer_widget">
                            ...
                            <p>
                                <?php echo e($front_config['subtitle']); ?>
...
</html><?php /**PATH C:\Users\joaov\OneDrive\Área de Trabalho\laravel\LaravelPainel\resources\views/site/layout.blade.php ENDPATH**/ ?>